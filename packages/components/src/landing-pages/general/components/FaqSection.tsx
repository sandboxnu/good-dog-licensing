...
export default function FaqSection() {
  return (
    <div>
      <h3 className="text-left text-[35px] font-medium not-italic leading-[96%] text-dark-gray-500 dark:text-mint-300 md:text-[48px]">
        Frequently asked questions
      </h3>
      <Accordion multiple={false} className="mt-[36px] gap-[8px]">
        <AccordionItem
          value="faq-1"
          className="rounded-[24px] border border-cream-400 bg-cream-100 px-[24px] shadow-card-light dark:border-dark-gray-400 dark:bg-green-600 dark:shadow-[0_2px_6px_0_#454545]"
        >
          <AccordionTrigger className="py-[24px] text-[18px] font-semibold leading-[120%] text-green-400 dark:text-mint-200 md:text-[20px]">
            What are PROs and why should I register?
          </AccordionTrigger>
          <AccordionContent className="pb-[24px] text-left text-[16px] font-medium text-dark-gray-500 dark:text-gray-300 md:text-[18px]">
