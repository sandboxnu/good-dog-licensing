...
export default function Footnote({ number, tooltip }: FootnoteProps) {
  ...
  return (
    <span className="relative">
      ...
      {open && (
        <span className="absolute bottom-full left-1/2 z-10 mb-1 flex w-[400px] -translate-x-1/2 flex-col items-start justify-center rounded-[8px] border border-cream-500 bg-gray-100 p-[16px] dark:border-cream-600 dark:bg-dark-gray-600 dark:shadow-[0_2px_6px_0_#171717]">
