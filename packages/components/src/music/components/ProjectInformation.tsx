...
export default function ProjectInformation({
  ...
  return (
    <div className="flex flex-col gap-4 p-6 rounded-2xl border-[0.5px] border-light-gray shadow-md">
      <p className="text-xl text-gray-200 dark:text-gray-100">Project Information</p>
      <div className="flex flex-col gap-1">
        <p className="text-gray-200 dark:text-gray-100">Project Title</p>
        <p className="text-gray-200 dark:text-gray-100">{projectSubmission ? projectSubmission.projectTitle : "..."}</p>
      </div>
      <div className="flex flex-col gap-1">
      ...
      <div className="flex flex-col gap-1">
        ...
        <p className="text-gray-200 dark:text-gray-100">{projectSubmission ? projectSubmission.description : "..."}</p>
      </div>
      {projectSubmission && projectSubmission.additionalInfo.length > 0 && (
        <div className="flex flex-col gap-1">
          ...
          <p className="text-gray-200 dark:text-gray-100">{projectSubmission.additionalInfo}</p>
        </div>
      )}
    </div>
  );
