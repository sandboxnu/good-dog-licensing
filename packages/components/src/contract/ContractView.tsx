    ...
    <div className="flex flex-col items-center w-full my-4">
      ...
      <div className="bg-white text-black w-full max-w-[850px] px-16 py-14 text-sm leading-relaxed font-serif">
        ...
        <p className="mb-4 text-justify">
          ...
          (&ldquo;Effective Date&rdquo;) is between{" "}
        ...
        <p className="mb-4 text-justify">
          <SectionLabel>Licensee</SectionLabel> is a media maker who has
          produced or is producing for distribution and/or public performance an
          audio or audiovisual project, as set forth in{" "}
        ...
        <p className="mb-6 text-justify">
          ...
          <span className="underline">Schedule B</span> attached hereto and made
          a part hereof (the <SectionLabel>&ldquo;Song&rdquo;</SectionLabel>)
          and who desires to grant all necessary rights to Licensee for
          Licensee&rsquo;s use of the Song in the Production, as set forth in{" "}
        ...
        <div className="mb-4">
          ...
          <div className="pl-6 space-y-2">
            <p className="text-justify">
              ...
              rights are granted under this License and whose title is provided
              in <span className="underline">Schedule B</span>.
            </p>
            <p className="text-justify">
              b. <SectionLabel>&ldquo;All Owners&rdquo;</SectionLabel> means all
              persons and/or entities who own and/or control any rights in and
              to the Song, including without limitation, recording artists,
              composers, songwriters, publishers, and/or producers, as may be
              set forth on <span className="underline">Schedule B</span>. The
              Licensor is the signatory to this License on behalf of All Owners.
            </p>
            <p className="text-justify">
            ...
            <p className="text-justify">
              d. <SectionLabel>&ldquo;Scope of Use&rdquo;</SectionLabel> means
              the details of the Song&rsquo;s use in the Production, set forth
              in <span className="underline">Schedule A</span>, with which the
            ...
            <p className="text-justify">
              ...
              for the life of copyright(s) to which rights are granted under
              this License.
            </p>
          </div>
        </div>
        ...
        <div className="mb-4">
          <p className="text-justify">
            ...
            anything to the contrary contained herein, if Licensee fails to
            comply with the conditions and limitations of this License, then
            this License will terminate automatically. To reinstate this
            License, Licensee must either (i) cure the failure to comply within
            30 days of the termination of this License, or (ii) receive express
            ...
            <div>
              ...
              <div className="pl-8 space-y-2">
                <p className="text-justify">
                  ...
                  record and synchronize the Song solely as described under
                  Scope of Use and the Duration set forth in{" "}
                ...
                <p className="text-justify">
                  ...
                  license to exhibit and publicly perform the Production
                  embodying the Song throughout the world (the{" "}
                ...
                <p className="text-justify">
                  ...
                  : an irrevocable, non-exclusive license to permit any third
                  party (&ldquo;Exhibitor&rdquo;) the right to exhibit and
                  publicly perform the Production embodying the Song throughout
                  the world (the{" "}
                  <SectionLabel>&ldquo;Territory&rdquo;</SectionLabel>) in any
                  medium or forum whether now known or hereafter devised,
                  conditioned upon each such Exhibitor having a valid
                  performance license from the person, firm, corporation or
                  other entity which has the legal right and authority to issue
                  licenses to publicly perform the Song in each country of the
                  Territory in which the Song shall be performed hereunder, or
                  from the Licensor directly.
                </p>
              </div>
            </div>
            <div>
              ...
              <div className="pl-8 space-y-2">
                <p className="text-justify">
                  ...
                  in <span className="underline">Schedule B</span>, in equal
                  size and prominence with other contributors to the Production.
                </p>
                <p className="text-justify">
                  ii. <SectionLabel>Cue Sheets.</SectionLabel> Subject to
                  Licensor affiliating with a Performance Rights Organization
                  (&ldquo;PRO&rdquo;) (e.g., ASCAP, BMI, SESAC), Licensee shall
                  file a cue sheet with such PRO (as set forth in Schedules A
                  and B).
                </p>
              </div>
            </div>
        ...
        <div className="mb-4">
          <p className="text-justify">
            ...
            covenant contained in this License including, without limitation,
            any claim by any third party in connection with the foregoing,
            provided such claim has been settled with Licensor&rsquo;s prior
            written consent (not to be unreasonably withheld) or reduced to
            judgment.
          </p>
        </div>
        ...
        <div className="mb-8">
          <p className="text-justify">
            ...
            This License constitutes the entire understanding between the
            Licensor and Licensee with respect to the subject matter of this
            License. Any additions or changes in this License shall be valid
            only if set forth in writing and signed by the Licensor and
            Licensee. This License may be executed in counterparts, each of
            which is deemed an original, but all of which together are deemed to
            be one and the same agreement. A signed copy of this License
            ...
            an original signed copy of this License.
          </p>
        </div>
        ...
        <div className="mb-10">
          ...
          <div className="mb-5">
            ...
            <p className="pl-4 text-justify">
              {contract.productionDescription}
            </p>
          </div>
