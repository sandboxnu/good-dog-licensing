  ...
  return (
    ...
    >
      <div className="flex flex-col gap-[8px]">
        <p className="text-body1 font-semibold leading-[0.96] text-dark-gray-500 dark:text-mint-300">
          {title}
        </p>
        <p className="text-caption leading-[0.96] text-dark-gray-500 dark:text-gray-200">
          {subheader}
        </p>
      </div>
