...
export default function MultiselectDropdown({
  ...
  return (
    <div className="flex w-full flex-col gap-[4px]">
      ...
      <MultiSelect
        className={clsx(
          "min-h-[32px] w-full rounded-[8px] border border-dark-gray-200 bg-white text-body3 text-dark-gray-500 dark:border-dark-gray-300 dark:bg-dark-gray-500 dark:text-gray-200 hover:border-gray-600 dark:hover:border-gray-400",
          {
